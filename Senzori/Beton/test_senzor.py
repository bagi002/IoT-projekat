#!/usr/bin/env python3
"""
Test skript za generisanje JSON podataka senzora betona
...
def generate_sensor_data():
    ...
    # Random vlažnost između 30 i 90 procenata
    vlaznost = round(random.uniform(30.0, 90.0), 1)
...
def main():
    print("Python Test Skript za Senzor Betona")
    print("="*40)
